...
export default function PropostaComercial({ 
  ...
  const styles = {
    ...
    destaque: { backgroundColor: '#ebf8ff', border: '1px solid #3182ce', padding: '4px', textAlign: 'center', margin: '8px 0' },
    destaqueValor: { fontSize: '16px', fontWeight: 'bold', color: '#2b6cb0' },
    observacoes: { backgroundColor: '#fffbeb', border: '1px dashed #d69e2e', padding: '4px', marginTop: '8px' },
